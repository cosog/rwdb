...
//									itemCount++;
								...
								if(dataResponseConfig.getDiagramResult().getColumns().getResultStatus().getEnable()){
									String value="null";
									if(calculateResponseData!=null&&(calculateResponseData.getCalculationStatus().getResultStatus()==1||calculateResponseData.getCalculationStatus().getResultStatus()==-99)){
										value=getOperaValue(calculateResponseData.getCalculationStatus().getResultStatus()+"",dataResponseConfig.getDiagramResult().getColumns().getResultStatus().getType(),dataResponseConfig.getDiagramResult().getColumns().getResultStatus().getRatio());
									}
									updateSql+= dataResponseConfig.getDiagramResult().getColumns().getResultStatus().getColumn()+ "="+value+",";
									insertColumns+=dataResponseConfig.getDiagramResult().getColumns().getResultStatus().getColumn()+",";
									insertValues+=value+",";
									itemCount++;
								}
								...
								}else if(calculateResponseData.getCalculationStatus().getResultStatus()!=1){
